...
- [x] Inspect stale generated comments in controller vLLM runtime path resolver.
- [x] Remove boilerplate JSDoc from `controller/src/modules/engines/runtimes/vllm-python-path.ts` without behavior changes.
- [x] Validate removed vLLM runtime path JSDoc does not remain.
