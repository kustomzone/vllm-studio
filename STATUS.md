...
- [x] Inspect agent sessions, setup, and workspace model reload hooks.
- [x] Replace agent sessions loading, active-session sync, setup data loading, and workspace model storage reload with `useSyncExternalStore`.
