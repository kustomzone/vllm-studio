...
- [x] Inspect session-engine cleanup and runtime resume effect helper hooks.
- [x] Replace pi event batch cleanup, text-delta cleanup, prompt-stream cleanup, and runtime resume subscription with `useSyncExternalStore`.
