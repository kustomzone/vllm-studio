...
- [x] Inspect comments in `frontend/src/lib/agent/session/block-event.ts`.
- [x] Remove decorative session block-event section headers.
- [x] Validate frontend block-event comment cleanup slice.
- [x] Commit this slice.
