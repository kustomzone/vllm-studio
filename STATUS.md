...
- [x] Inspect configs, engine runtime, and settings discovery lifecycle hooks.
- [x] Replace config loading, engine job polling, hash section sync, archived chats loading, plugin loading, skill loading, and setup-check loading with `useSyncExternalStore`.
