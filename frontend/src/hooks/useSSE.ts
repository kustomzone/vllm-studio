 ...
 * });
 */
export function useSSE(url: string, enabled: boolean = true, options: SSEOptions = {}) {
  ...
  const { onMessage, onError, reconnectDelay = 3000, maxReconnectAttempts = Infinity } = options;
