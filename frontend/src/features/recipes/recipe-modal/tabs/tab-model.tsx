...
export function RecipeModalTabModel({
  ...
  const showContextSection = capabilities.contextLength || capabilities.seed;
  const showWeightsSection =
    capabilities.advancedModelLoading || capabilities.quantization || capabilities.trustRemoteCode;
              ...
              <div className="grid grid-cols-2 gap-3">
                <FormField label="Tokenizer">
                  <Input
                    ...
                    onChange={(e) =>
                      onChange({ ...recipe, tokenizer: e.target.value || undefined })
                    }
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <FormField label="Load Format">
                  <Input
                    ...
                    onChange={(e) =>
                      onChange({ ...recipe, load_format: e.target.value || undefined })
                    }
