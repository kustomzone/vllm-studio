...
export function RecipeModalTabPerformance({
  ...
  const showKvSection = capabilities.kvCacheDtype || capabilities.blockSize || capabilities.caching;
  const showSchedulerSection = capabilities.maxNumSeqs || capabilities.schedulerAdvanced;
          ...
          <div className="grid grid-cols-3 gap-3">
            {capabilities.maxNumSeqs ? (
              <FormField
                label="Max Sequences"
                description={
                  capabilities.backend === "sglang" ? "--max-running-requests" : undefined
                }
              >
                <Input
                  type="number"
