...
export const MCP_CATALOGUE: McpCatalogueEntry[] = [
  ...
  },
  {
    ...
    displayName: "GitHub",
    description:
      "GitHub repositories, issues, pull requests, and code search through the official remote MCP endpoint. The remote MCP proxy opens GitHub sign-in when the plugin first runs.",
    shortDescription: "GitHub remote MCP",
    category: "Engineering",
    tags: ["github", "oauth", "remote", "curated"],
    command: "npx",
    args: ["-y", "mcp-remote", "https://api.githubcopilot.com/mcp/", "--transport", "http-only"],
  ...
  },
  {
    ...
    description:
      "Official Hugging Face Hub MCP server for models, datasets, Spaces, and paper discovery. The remote MCP proxy opens Hugging Face sign-in when the plugin first runs.",
    shortDescription: "Hugging Face remote MCP",
    category: "AI",
