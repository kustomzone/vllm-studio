...
export const MCP_CATALOGUE: McpCatalogueEntry[] = [
  ...
  },
  {
    ...
    displayName: "GitHub",
    description:
      "Interact with GitHub: repos, issues, pull requests, and code search. Connect with OAuth, or paste a personal access token as a fallback.",
    shortDescription: "GitHub API access",
    category: "Engineering",
    tags: ["github", "official", "oauth", "remote"],
    registry: "curated",
    command: "npx",
