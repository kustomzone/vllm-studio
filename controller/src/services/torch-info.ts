// CRITICAL
import type { RuntimeTorchBuildInfo } from "../types/models";
import { runCommand } from "./command/command-utilities";

/**
 * Read PyTorch build metadata (CUDA/HIP) from a Python interpreter.
 * @param python - Python executable path.
 * @returns Torch build info.
 */
